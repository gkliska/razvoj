...
# added vmax property by Jean-Christophe VASSORT <jvt@thamini.com>
...
def _setupLabel(labelClass, text, radius, cx, cy, angle, car, sar, sty):
    ...
    if a in (90,270):
        L.boxAnchor = 'c'
    # Left part, anchor at right of text
    if a > 90 and a < 270:
        L.boxAnchor = 'e'
    # Right part, anchor at left of text
    if a < 90 or a > 270:
        L.boxAnchor = 'w'
...
class SpiderChart(PlotArea):
    _attrMap = AttrMap(BASE=PlotArea,
        ...
        vmax = AttrMapValue(None, 'max value size'),
        )
