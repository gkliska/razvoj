...
class training_course(osv.osv):
    ...
    _columns = {
        ...
        'questionnaire_ids': fields.one2many('training.exam.questionnaire.course', 'course_id', string='Questionnaires'),
...
class exam_questionnaire(osv.osv):
    ...
    _columns = {
        ...
        'active': fields.boolean('Active', help="Only one questionnaire are available same course."),
